 ...
 * </p>
 * <p>
 * The idea is to create virtual blocks of output in a line (i.e. invisible tabbing points) and when a new line is printed tab the output with spaces (or some
 * similar invisible character) to the last tabbing points. Alignment blocks are created in a LIFO fashion that is and you can only align w.r.t. latest block.
 * </p>
 * <p>
 * This class is an abstract class to provide some general functionality that can be reused in implementations that supports purely textual output or HTML
 * output.
 * </p>
 * <p>
