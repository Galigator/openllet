...
public class RationalTests
{
	...
	/**
	 * Test that equality is dependent on numerator and denominator, not numeric value.
	 */
	@Test
	...
	public void validParse()
	{
		...
		assertNotNull(r);
		assertEquals(new Rational(OWLRealUtils.getCanonicalObject(1), OWLRealUtils.getCanonicalObject(3)), r);

		r = Rational.valueOf("12 / 36");
		assertNotNull(r);
		assertEquals(new Rational(OWLRealUtils.getCanonicalObject(12), OWLRealUtils.getCanonicalObject(36)), r);
