...
public class ContinuousRealIntervalTests
{
	...
	public static ContinuousRealInterval interval(final Double l, final Double u, final boolean il, final boolean iu)
	{
		return new ContinuousRealInterval(l == null ? null : BigDecimal.valueOf(l), u == null ? null : BigDecimal.valueOf(u), il, iu);
	}
	...
	/**
	 * Verify that if two intervals meet (i.e., one's upper is the other's lower and the (in|ex)clusiveness differs), then they do not intersect.
	 */
	@Test
	...
	/**
	 * Verify that the overlap of two intervals with exclusive bounds intersect correctly.
	 */
	@Test
	...
	/**
	 * Verify that the overlap of two intervals with inclusive bounds intersect correctly.
	 */
	@Test
	...
	/**
	 * Verify that two intervals overlapping just on an inclusive bound intersect to a point.
	 */
	@Test
	public void intersectionPoint()
	{
		...
		final ContinuousRealInterval expected = new ContinuousRealInterval(BigDecimal.valueOf(2.1d));
	...
	/**
	 * Verify that the intersection of a interval with a interval which it starts and which share an inclusive endpoint is correct.
	 */
	@Test
	...
	/**
	 * Verify that the intersection of a interval with a interval which it starts and which share an exclusive endpoint is correct.
	 */
	@Test
	...
	/**
	 * Verify that the intersection of a interval with a interval which it starts but for which the endpoint type is different it correct (i.e., it isn't a
	 * start relation).
	 */
	@Test
	...
	{
		final ContinuousRealInterval interval = new ContinuousRealInterval(null, null, false, false);
