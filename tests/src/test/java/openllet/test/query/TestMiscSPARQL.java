...
public class TestMiscSPARQL
{
	...
	public void test()
	{
		...
		final boolean uas = OpenlletOptions.USE_ANNOTATION_SUPPORT;
		OpenlletOptions.USE_ANNOTATION_SUPPORT = false;
		...
		{
			OpenlletOptions.USE_ANNOTATION_SUPPORT = uas;
		}
	}
	...
	{
		final boolean savedValue = OpenlletOptions.USE_ANNOTATION_SUPPORT;

		for (final boolean b : new boolean[] { false, true })
		{
			OpenlletOptions.USE_ANNOTATION_SUPPORT = b;
