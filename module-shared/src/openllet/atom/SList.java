 ...
 * Standard List
 *
 * @param <Atom> should be a kind of ATerm.
 *
 * @since        2.6.0
 */
public interface SList<Atom> extends Iterable<Atom>
{
	 ...
	 * @see          #indexOf
	 */
	int lastIndexOf(Atom el, int start);
	 ...
	 */
	SList<Atom> concat(SList<Atom> rhs);
	 ...
	 */
	SList<Atom> insertAt(Atom el, int i);
	 ...
	 */
	SList<Atom> getSlice(int start, int end);
	 ...
	 *                                   to a position in this list.
	 */
	SList<Atom> replace(Atom el, int i);
	 ...
	 */
	SList<Atom> dictPut(Atom key, Atom value);
	 ...
	 * @return     the new dictionary list
	 */
	SList<Atom> dictRemove(Atom key);
