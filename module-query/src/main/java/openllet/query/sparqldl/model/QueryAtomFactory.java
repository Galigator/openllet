...
public class QueryAtomFactory
{
	...
	public static QueryAtom PropertyValueAtom(final ATermAppl iA, final ATermAppl pA, final ATermAppl ilA)
	{
		return new QueryAtomImpl(QueryPredicate.PropertyValue, iA, pA, ilA);
	}

	public static QueryAtom NegativePropertyValueAtom(final ATermAppl iA, final ATermAppl pA, final ATermAppl ilA)
	{
	...
	public static QueryAtom DifferentFromAtom(final ATermAppl iA1, final ATermAppl iA2)
	{
		return new QueryAtomImpl(QueryPredicate.DifferentFrom, iA1, iA2);
	}

	// TBOX atoms
	public static QueryAtom SubClassOfAtom(final ATermAppl cA1, final ATermAppl cA2)
	{
		return new QueryAtomImpl(QueryPredicate.SubClassOf, cA1, cA2);
	}

	public static QueryAtom EquivalentClassAtom(final ATermAppl classArgument, final ATermAppl classArgument2)
	{
		return new QueryAtomImpl(QueryPredicate.EquivalentClass, classArgument, classArgument2);
	}

	public static QueryAtom DisjointWithAtom(final ATermAppl cA1, final ATermAppl cA2)
	{
		return new QueryAtomImpl(QueryPredicate.DisjointWith, cA1, cA2);
	}

	public static QueryAtom ComplementOfAtom(final ATermAppl cA1, final ATermAppl cA2)
	{
		return new QueryAtomImpl(QueryPredicate.ComplementOf, cA1, cA2);
	}

	// RBOX atoms
	public static QueryAtom SubPropertyOfAtom(final ATermAppl pA1, final ATermAppl pA2)
	{
		return new QueryAtomImpl(QueryPredicate.SubPropertyOf, pA1, pA2);
	}

	public static QueryAtom EquivalentPropertyAtom(final ATermAppl pA1, final ATermAppl pA2)
	{
		return new QueryAtomImpl(QueryPredicate.EquivalentProperty, pA1, pA2);
	}

	public static QueryAtom DomainAtom(final ATermAppl pA1, final ATermAppl cA2)
	{
		return new QueryAtomImpl(QueryPredicate.Domain, pA1, cA2);
	}

	public static QueryAtom RangeAtom(final ATermAppl pA1, final ATermAppl cA2)
	{
		return new QueryAtomImpl(QueryPredicate.Range, pA1, cA2);
	}

	public static QueryAtom InverseOfAtom(final ATermAppl pA1, final ATermAppl pA2)
	{
	...
	public static QueryAtom PropertyDisjointWithAtom(final ATermAppl pA1, final ATermAppl pA2)
	{
		return new QueryAtomImpl(QueryPredicate.propertyDisjointWith, pA1, pA2);
	}

	public static QueryAtom AnnotationAtom(final ATermAppl iA, final ATermAppl pA, final ATermAppl ilA)
	{
		return new QueryAtomImpl(QueryPredicate.Annotation, iA, pA, ilA);
	}

	// SPARQL-DL nonmonotonic extension
	public static QueryAtom StrictSubClassOfAtom(final ATermAppl c1, final ATermAppl c2)
	{
		return new QueryAtomImpl(QueryPredicate.StrictSubClassOf, c1, c2);
	}

	public static QueryAtom DirectSubClassOfAtom(final ATermAppl c1, final ATermAppl c2)
	{
		return new QueryAtomImpl(QueryPredicate.DirectSubClassOf, c1, c2);
	}

	public static QueryAtom DirectSubPropertyOfAtom(final ATermAppl c1, final ATermAppl c2)
	{
		return new QueryAtomImpl(QueryPredicate.DirectSubPropertyOf, c1, c2);
	}

	public static QueryAtom StrictSubPropertyOfAtom(final ATermAppl c1, final ATermAppl c2)
	{
	...
	public static QueryAtom Core(final Collection<QueryAtom> atoms, final Collection<ATermAppl> uv, final KnowledgeBase kb)
	{
		return new CoreNewImpl(atoms, uv, kb);
	}

	public static QueryAtom NotKnownAtom(final QueryAtom atom)
	{
		return new NotKnownQueryAtom(atom);
	}

	public static QueryAtom NotKnownAtom(final QueryAtom... atoms)
	{
		return new NotKnownQueryAtom(Arrays.asList(atoms));
	}

	public static QueryAtom NotKnownAtom(final List<QueryAtom> atoms)
	{
		return new NotKnownQueryAtom(atoms);
	}

	public static QueryAtom UnionAtom(final List<List<QueryAtom>> union)
	{
