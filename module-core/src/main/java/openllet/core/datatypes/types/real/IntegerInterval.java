...
public class IntegerInterval extends DiscreteInterval<Number, IntegerInterval>
{
	...
	protected int compare(final Number a, final NullSemantics na, final Number b, final NullSemantics nb)
	{
		...
		if (a == null && NA.equals(na)) throw new NullPointerException();

		if (b == null && NA.equals(nb)) throw new NullPointerException();
	...
	public boolean equals(final Object obj)
	{
		...
		if (getLower() == null)
		{
			if (other.getLower() != null) return false;
		}
		else
		{
			if (other.getLower() == null) return false;
			if (OWLRealUtils.compare(getLower(), other.getLower()) != 0) return false;
		}
		if (getUpper() == null)
		{
			if (other.getUpper() != null) return false;
		}
		else
		{
			if (other.getUpper() == null) return false;
			if (OWLRealUtils.compare(getUpper(), other.getUpper()) != 0) return false;
		}
	...
	public Number size()
	{
		if (getLower() == null || getUpper() == null) throw new IllegalStateException();
