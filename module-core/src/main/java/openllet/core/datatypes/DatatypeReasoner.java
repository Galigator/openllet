...
public interface DatatypeReasoner
{
	 ...
	 */
	boolean containsAtLeast(int n, Collection<ATermAppl> ranges) throws InvalidConstrainingFacetException, InvalidLiteralException, UnrecognizedDatatypeException;
	 ...
	 */
	boolean declare(ATermAppl name);
	 ...
	 */
	ATermAppl getCanonicalRepresentation(ATermAppl literal) throws InvalidLiteralException, UnrecognizedDatatypeException;
	 ...
	 */
	Datatype<?> getDatatype(ATermAppl uri);
	 ...
	 * @throws UnrecognizedDatatypeException if the datatype is not recognized
	 */
	Object getValue(ATermAppl literal) throws InvalidLiteralException, UnrecognizedDatatypeException;
	 ...
	 *         false</code> else
	 */
	boolean isDeclared(ATermAppl name);
	 ...
	 */
	boolean isDefined(ATermAppl name);
	 ...
	 */
	ATermAppl getDefinition(ATermAppl name);
	 ...
	 * @throws UnrecognizedDatatypeException
	 */
	boolean isSatisfiable(Collection<ATermAppl> dataranges) throws InvalidConstrainingFacetException, InvalidLiteralException, UnrecognizedDatatypeException;
	 ...
	 * @throws UnrecognizedDatatypeException
	 */
	boolean isSatisfiable(Collection<ATermAppl> dataranges, Object value) throws InvalidConstrainingFacetException, InvalidLiteralException, UnrecognizedDatatypeException;
	 ...
	 * @throws UnrecognizedDatatypeException
	 */
	boolean isSatisfiable(Set<Literal> nodes, Map<Literal, Set<Literal>> ineqs) throws InvalidConstrainingFacetException, InvalidLiteralException, UnrecognizedDatatypeException;
	 ...
	 */
	boolean define(ATermAppl name, ATermAppl datarange);
	 ...
	 * @throws UnrecognizedDatatypeException
	 */
	boolean validLiteral(ATermAppl typedLiteral) throws UnrecognizedDatatypeException;
	 ...
	 */
	Iterator<?> valueIterator(Collection<ATermAppl> dataranges) throws InvalidConstrainingFacetException, InvalidLiteralException, UnrecognizedDatatypeException;
}
