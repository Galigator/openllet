...
public class AxiomConverter implements FacetFactoryOWL
{
	...
	{
		if (kb == null) throw new OpenError("KnowledgeBase is null");
		if (factory == null) throw new OpenError("OWLDataFactory is null");
	...
	public OWLAxiom convert(final ATermAppl termParam)
	{
		...
		if (term.getAFun().equals(ATermUtils.EQCLASSFUN))
		{
			...
			if (c1 != null && c2 != null) axiom = _factory.getOWLEquivalentClassesAxiom(descriptions);
		}
		else if (term.getAFun().equals(ATermUtils.SUBFUN))
		{
			...
			if (c1 != null && c2 != null) axiom = _factory.getOWLSubClassOfAxiom(c1, c2);
		}
		else if (term.getAFun().equals(ATermUtils.DISJOINTSFUN))
		{
			...
			if (concepts.isEmpty()) axiom = _factory.getOWLDisjointClassesAxiom(descriptions);
		}
		else if (term.getAFun().equals(ATermUtils.DISJOINTFUN))
		{
			...
			if (c1 != null && c2 != null) axiom = _factory.getOWLDisjointClassesAxiom(descriptions);
		}
		else if (term.getAFun().equals(ATermUtils.DISJOINTPROPSFUN))
		{
			...
			// if no error occurred list will be empty
			if (props.isEmpty()) if (!objProperties.isEmpty())
		...
		else if (term.getAFun().equals(ATermUtils.DISJOINTPROPFUN))
		{
			...
			if (p1 != null && p2 != null) if (p1 instanceof OWLObjectProperty && p2 instanceof OWLObjectProperty)
				axiom = _factory.getOWLDisjointObjectPropertiesAxiom(SetUtils.create((OWLObjectProperty) p1, (OWLObjectProperty) p2));
			else if (p1 instanceof OWLDataProperty && p2 instanceof OWLDataProperty) axiom = _factory.getOWLDisjointDataPropertiesAxiom(SetUtils.create((OWLDataProperty) p1, (OWLDataProperty) p2));
		}
		else if (term.getAFun().equals(ATermUtils.SUBPROPFUN))
		{
			if (term.getArgument(0) instanceof ATermList)
			{
				...
				if (subs != null && sup != null) axiom = _factory.getOWLSubPropertyChainOfAxiom(subs, sup);
			}
			else
			{
				final OWLObject p1 = _conceptConverter.convert((ATermAppl) term.getArgument(0));
				...
				if (p1 != null && p2 != null) if (p1 instanceof OWLObjectPropertyExpression && p2 instanceof OWLObjectPropertyExpression)
					axiom = _factory.getOWLSubObjectPropertyOfAxiom((OWLObjectPropertyExpression) p1, (OWLObjectPropertyExpression) p2);
				else if (p1 instanceof OWLDataProperty && p2 instanceof OWLDataProperty) axiom = _factory.getOWLSubDataPropertyOfAxiom((OWLDataProperty) p1, (OWLDataProperty) p2);
			}
		}
		else if (term.getAFun().equals(ATermUtils.EQPROPFUN))
		{
			...
			else if (p1 instanceof OWLDataProperty && p2 instanceof OWLDataProperty) axiom = _factory.getOWLEquivalentDataPropertiesAxiom(SetUtils.create((OWLDataProperty) p1, (OWLDataProperty) p2));
		}
		else if (term.getAFun().equals(ATermUtils.DOMAINFUN))
		{
			...
			if (c != null && p != null) if (p instanceof OWLObjectProperty)
		...
		else if (term.getAFun().equals(ATermUtils.RANGEFUN))
		{
			...
			if (e != null) if (e instanceof OWLClassExpression)
			{
				final OWLObjectProperty p = (OWLObjectProperty) _conceptConverter.convert((ATermAppl) term.getArgument(0));
				if (p != null) axiom = _factory.getOWLObjectPropertyRangeAxiom(p, (OWLClassExpression) e);
			}
			else
			{
				final OWLDataProperty p = (OWLDataProperty) _conceptConverter.convert((ATermAppl) term.getArgument(0));
				if (p != null) axiom = _factory.getOWLDataPropertyRangeAxiom(p, (OWLDataRange) e);
			}
		}
		else if (term.getAFun().equals(ATermUtils.INVPROPFUN))
		{
			...
			if (p1 != null && p2 != null) axiom = _factory.getOWLInverseObjectPropertiesAxiom(p1, p2);
		}
		else if (term.getAFun().equals(ATermUtils.TRANSITIVEFUN))
		{
			final OWLObjectProperty p = (OWLObjectProperty) _conceptConverter.convert((ATermAppl) term.getArgument(0));

			if (p != null) axiom = _factory.getOWLTransitiveObjectPropertyAxiom(p);
		}
		else if (term.getAFun().equals(ATermUtils.FUNCTIONALFUN))
		{
			final OWLObject p = _conceptConverter.convert((ATermAppl) term.getArgument(0));

			if (p != null) if (p instanceof OWLObjectProperty)
				axiom = _factory.getOWLFunctionalObjectPropertyAxiom((OWLObjectPropertyExpression) p);
			else if (p instanceof OWLDataProperty) axiom = _factory.getOWLFunctionalDataPropertyAxiom((OWLDataPropertyExpression) p);
		}
		else if (term.getAFun().equals(ATermUtils.INVFUNCTIONALFUN))
		{
			final OWLObjectProperty p = (OWLObjectProperty) _conceptConverter.convert((ATermAppl) term.getArgument(0));

			if (p != null) axiom = _factory.getOWLInverseFunctionalObjectPropertyAxiom(p);
		}
		else if (term.getAFun().equals(ATermUtils.SYMMETRICFUN))
		{
			final OWLObject p = _conceptConverter.convert((ATermAppl) term.getArgument(0));

			if (p != null && p instanceof OWLObjectPropertyExpression) axiom = _factory.getOWLSymmetricObjectPropertyAxiom((OWLObjectPropertyExpression) p);
		}
		else if (term.getAFun().equals(ATermUtils.ASYMMETRICFUN))
		{
			final OWLObject p = _conceptConverter.convert((ATermAppl) term.getArgument(0));

			if (p != null && p instanceof OWLObjectPropertyExpression) axiom = _factory.getOWLAsymmetricObjectPropertyAxiom((OWLObjectPropertyExpression) p);
		}
		else if (term.getAFun().equals(ATermUtils.REFLEXIVEFUN))
		{
			final OWLObject p = _conceptConverter.convert((ATermAppl) term.getArgument(0));

			if (p != null && p instanceof OWLObjectPropertyExpression) axiom = _factory.getOWLReflexiveObjectPropertyAxiom((OWLObjectPropertyExpression) p);
		}
		else if (term.getAFun().equals(ATermUtils.IRREFLEXIVEFUN))
		{
			final OWLObject p = _conceptConverter.convert((ATermAppl) term.getArgument(0));

			if (p != null && p instanceof OWLObjectPropertyExpression) axiom = _factory.getOWLIrreflexiveObjectPropertyAxiom((OWLObjectPropertyExpression) p);
		}
		else if (term.getAFun().equals(ATermUtils.TYPEFUN))
		{
			...
			if (i != null && c != null) axiom = _factory.getOWLClassAssertionAxiom(c, i);
		}
		else if (term.getAFun().equals(ATermUtils.PROPFUN))
		{
			...
			if (subj != null) if (ATermUtils.isLiteral((ATermAppl) term.getArgument(2)))
			{
				...
				if (pred != null && obj != null) axiom = _factory.getOWLDataPropertyAssertionAxiom(pred, subj, obj);
			}
			else
			{
				...
				if (pred != null && obj != null) axiom = _factory.getOWLObjectPropertyAssertionAxiom(pred, subj, obj);
			}
		}
		else if (term.getAFun().equals(ATermUtils.NOTFUN) && ((ATermAppl) term.getArgument(0)).getAFun().equals(ATermUtils.PROPFUN))
		{
			...
			if (subj != null) if (ATermUtils.isLiteral((ATermAppl) term.getArgument(2)))
			{
				final OWLDataProperty pred = (OWLDataProperty) _conceptConverter.convert((ATermAppl) term.getArgument(0));
				final OWLLiteral obj = (OWLLiteral) _conceptConverter.convert((ATermAppl) term.getArgument(2));
				if (pred != null && obj != null) axiom = _factory.getOWLNegativeDataPropertyAssertionAxiom(pred, subj, obj);
			}
			else
			{
				final OWLObjectProperty pred = (OWLObjectProperty) _conceptConverter.convert((ATermAppl) term.getArgument(0));
				final OWLIndividual obj = _conceptConverter.convertIndividual((ATermAppl) term.getArgument(2));
				if (pred != null && obj != null) axiom = _factory.getOWLNegativeObjectPropertyAssertionAxiom(pred, subj, obj);
			}
		}
		else if (term.getAFun().equals(ATermUtils.SAMEASFUN))
		{
			...
			if (ind1 != null && ind2 != null) axiom = _factory.getOWLSameIndividualAxiom(inds);
		}
		else if (term.getAFun().equals(ATermUtils.DIFFERENTFUN))
		{
			...
			if (ind1 != null && ind2 != null) axiom = _factory.getOWLDifferentIndividualsAxiom(inds);
		}
		else if (term.getAFun().equals(ATermUtils.ALLDIFFERENTFUN))
		{
			...
			// if no error occurred list will be empty
			if (list.isEmpty()) axiom = _factory.getOWLDifferentIndividualsAxiom(individuals);
		}
		...
		else if (term.getAFun().equals(ATermUtils.DATATYPEDEFFUN))
		{
			...
			if (d1 != null && d2 != null) axiom = _factory.getOWLDatatypeDefinitionAxiom(d1, d2);
		}

		if (axiom == null) _logger.warning("Cannot convert to OWLAPI: " + term);
	...
	private SWRLAtom parseToSWRLAtom(final ATermAppl term)
	{
		...
		else if (term.getAFun().equals(ATermUtils.PROPFUN))
		{
			...
			else if (_kb.isDatatypeProperty(p))
			{
		...
		if (atom == null) _logger.warning("Cannot convert to SWRLAtom: " + term);
	...
	{
		if (ATermUtils.isVar(t)) return _factory.getSWRLVariable(IRI.create(((ATermAppl) t.getArgument(0)).getName()));
		if (_kb.isIndividual(t)) return _factory.getSWRLIndividualArgument(_conceptConverter.convertIndividual(t));
	...
	private SWRLDArgument parseToAtomDObject(final ATermAppl t)
	{
		...
		else if (ATermUtils.isLiteral(t)) return _factory.getSWRLLiteralArgument((OWLLiteral) _conceptConverter.convert(t));
